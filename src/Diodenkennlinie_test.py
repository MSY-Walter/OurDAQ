...
SPANNUNG_GEMESSEN = hat.a_in_read(0)
...
def main():
    ...
    try:
        ...
        for i in range(anzahl_punkte):
            ...
            # Strom berechnen
            strom = (SPANNUNG_GEMESSEN - spannung_diode) / r_serie

            # Werte speichern
            eingestellte_spannungen.append(SPANNUNG_GEMESSEN)
            diodenspannungen.append(spannung_diode)
            stroeme.append(strom)

            print(f"Eingestellte Spannung: {SPANNUNG_GEMESSEN:.3f} V | "
