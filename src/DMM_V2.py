...
class MesswertAnzeige(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        self.dezimalstellen = 2  # Standardmäßig 2 Dezimalstellen
    ...
    def set_bereich(self, bereich):
        ...
        # Anpassung der Dezimalstellen basierend auf dem Messbereich
        if bereich >= 10.0:
            self.dezimalstellen = 2
        elif bereich >= 1.0:
...
class DigitalMultimeter(QMainWindow):
    ...
    def aktualisiere_bereiche(self):
        ...
        if "Spannung" in self.modus:
            # LabVIEW-ähnliche Messbereiche von 20V bis 200mV
            self.bereich_combo.addItems(["20V", "10V", "5V", "2V", "1V", "500mV", "200mV"])
            self.bereich = 20.0  # Standardmäßig 20V
    ...
    def bereich_geaendert(self):
        ...
        # MCC 118 unterstützt maximal ±10V, prüfen und warnen wenn nötig
        if self.bereich > 10.0 and "Spannung" in self.modus:
            QMessageBox.warning(
                self, "Hinweis zum Messbereich", 
                "Der MCC 118 unterstützt maximal ±10V Eingangsspannung. Spannungen über 10V können nicht korrekt gemessen werden!"
            )
    ...
    def hilfe_anzeigen(self):
        ...
        2. Wählen Sie den Messbereich (20V bis 200mV)
        ...
        - Wenn Sie einen Messbereich über 10V wählen, werden höhere Spannungen nicht korrekt gemessen
        - Die Dezimalstellen der Anzeige passen sich automatisch dem Messbereich an:
          * 20V & 10V: 2 Dezimalstellen
          * 5V, 2V & 1V: 3 Dezimalstellen
          * 500mV: 4 Dezimalstellen
          * 200mV: 5 Dezimalstellen
        """